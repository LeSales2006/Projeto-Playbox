...
public class Brinquedo {
    ...
    @ManyToOne
    @JoinColumn(name = "id_categoria") // nome da coluna no banco
    private Categoria categoria;

    public Brinquedo(){}

    public Brinquedo(Integer codigo, String descricao, String descricao_detalhada, Float preco, String marca, String imagem_base_64, Integer acessos, Categoria categoria){
        this.codigo = codigo;
